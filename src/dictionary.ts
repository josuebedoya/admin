export const dictionary = {
  ...
  msg: {
    ...
    DELETE_DATA_FAILED: 'Error al eliminar el registro/s',
    DELETE_DATA_SUCCESS: 'Registro/s eliminado exitosamente',
    DELETE_DATA_ERROR: 'Error al eliminar el registro/s',
